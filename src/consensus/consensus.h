...
/** The minimum allowed ZisK transaction version (network rule) */
static const int32_t ZISK_MIN_TX_VERSION = 6;
/** The maximum allowed ZisK transaction version (network rule) */
static const int32_t ZISK_MAX_TX_VERSION = 6;
